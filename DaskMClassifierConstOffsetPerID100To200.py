...
- Attack: Constant Offset Per ID 100-200m
...
class DaskMClassifierConstOffsetPerID100To200:
    """
    ...
    def run(self):
        self.logger.log("=" * 60)
        self.logger.log("DASK PIPELINE: ConstOffsetPerID 100-200m Attack Detection")
        self.logger.log("=" * 60)
...
if __name__ == "__main__":
    mcplu = DaskMClassifierConstOffsetPerID100To200()
    mcplu.run()
