...
class MDataClassifier:
    ...
    def plot_confusion_matrix(self, confusion_matrix, model_name):
        path = self._pathprovider.getPathWithModelName("MDataClassifier.plot_confusion_matrix_path")
        path = f"{path}{model_name}.png"
        os.makedirs(os.path.dirname(path), exist_ok=True)
        # sets the labels to "Regular" and "Malicious" by default
        labels = self._contextprovider.get("MDataClassifier.plot_confusion_matrix_labels", ["Regular", "Malicious"])
